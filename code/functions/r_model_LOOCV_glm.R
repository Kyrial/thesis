...
#bloc 1
plot_summs(model_conv5_3$finalModel,model_input_1$finalModel,model_conv1_1$finalModel,model_conv1_2$finalModel,model_pool1$finalModel,
           scale = TRUE, model.names = c(" ","input","conv1_1","conv1_2","pool_1"))
#bloc 2
plot_summs(model_conv5_3$finalModel,model_conv2_1$finalModel,model_conv2_2$finalModel,model_pool2$finalModel,
           scale = TRUE, model.names = c(" ","conv2_1","conv2_2","pool_2"))
#bloc 3
plot_summs(model_conv5_3$finalModel,model_conv3_1$finalModel,model_conv3_2$finalModel,model_conv3_3$finalModel,model_pool3$finalModel,
           scale = TRUE, model.names = c(" ","conv3_1","conv3_2","conv3_3","pool_3"))
#bloc 4
plot_summs(model_conv5_3$finalModel,model_conv4_1$finalModel,model_conv4_2$finalModel,model_conv4_3$finalModel,model_pool4$finalModel,
           scale = TRUE, model.names = c("","conv4_1","conv4_2","conv4_3","pool_4"))
#bloc 5
plot_summs(model_conv5_1$finalModel,model_conv5_2$finalModel,model_conv5_3$finalModel,model_pool5$finalModel,
